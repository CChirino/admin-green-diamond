<template lang="html">
    <div class="table-responsive">
        <table class="table ps-table">
            ...
            <tbody>
                <tr v-for="users in users" :key="users.id">
                    ...
                    <td>
                            <i class="icon-pencil mr-2" v-on:click.prevent="openModal(users);" style="cursor: pointer;"></i>
                        <a href="#"  ><!--$refs.modal.openModal()-->
                        </a>
                        <a href="#" v-on:click.prevent="deleteUser(users)">
        ...
        <div class="ps-section__footer">
            <ul class="pagination">
                <li>
                    <a href="#" @click="pagination.page--; listUser();">
                        <i class="icon icon-chevron-left"></i>
                    </a>
                </li>
                <li class="active" v-for="n in users.last_page" :key="n" :class="{active:pagination.page==n}">
                    <a href="#" @click="pagination.page=n; listUser();">{{n}}</a>
                </li>
                <li>
                    <a href="#" @click="pagination.page++; listUser();">
...
export default {
    ...
    methods: {
    listUser: function(){
        var url = 'http://127.0.0.1:8000/api/admin/users/'
